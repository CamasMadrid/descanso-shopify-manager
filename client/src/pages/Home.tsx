...
export default function Home() {
  ...
  const copy = isSpanish
    ? {
        ...
        outsideZone: "¿Más lejos? Te buscamos la ruta más económica y te confirmamos el precio antes de reservar.",
    ...
    : {
        ...
        outsideZone: "Further away? We will find the most economical route and confirm the price before you reserve.",
